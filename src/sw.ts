...
import type { NetworkOnlyOptions, StaleWhileRevalidateOptions, NetworkFirstOptions } from 'workbox-strategies'; // Importar tipos específicos
...
registerRoute(
  ...
  } as NetworkOnlyOptions) // Explicitly cast to NetworkOnlyOptions
);
...
registerRoute(
  ...
  } as StaleWhileRevalidateOptions) // Explicitly cast to StaleWhileRevalidateOptions
);
...
registerRoute(
  ...
  } as NetworkFirstOptions) // Explicitly cast to NetworkFirstOptions
);
